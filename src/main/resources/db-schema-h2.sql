...
create table dictionary(id int identity(1,1),value int,name varchar(255));
create table dictionary_data(id int identity(1,1),dictValue int,dataValue int,dataName varchar(255));
