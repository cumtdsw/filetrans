...
public class HttpHelper {
	...
	public static String uploadFiles(String apiUrl, File file, TaskModel taskModel) {
		...
		try {
			...
			String taskJson = JsonUtil.Object2Json(taskModel);
			httpPost.setHeader(Constants.HTTP_HEAD_TASKMODEL, taskJson);
